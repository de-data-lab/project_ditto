# this is the addition of some leaflet proxy functions that allow you to modify color palette without redrawing the actual shapes (huge load time)
# more info here: https://github.com/rstudio/leaflet/issues/496#issuecomment-650122985
